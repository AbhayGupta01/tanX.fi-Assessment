...
const Cart = () => {
  ...
  //     }}
  //   >
  //     {store.cartItems.length && localStorage.getItem("currUser") === "true" ? (
  ...
  //             Your cart is empty! Try adding more products by clicking on the
  //             products tab...
  //           </h5>
  //         </CardBody>
  //       </Card>
  ...
  //         <CardBody className="d-flex justify-content-center align-items-center">
  //           <h5 className="text-secondary">
  //             Please SignIn to add items to the cart!
  //           </h5>
  //         </CardBody>
  //       </Card>
  //     )}
